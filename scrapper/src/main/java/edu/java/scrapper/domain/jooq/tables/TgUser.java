...
public class TgUser extends TableImpl<TgUserRecord> {
    ...
    /**
     * The column <code>TG_USER.USER_CHAT_ID</code>.
     */
    public final TableField<TgUserRecord, Long> USER_CHAT_ID =
        createField(DSL.name("USER_CHAT_ID"), SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>TG_USER.USER_STATE</code>.
     */
    public final TableField<TgUserRecord, String> USER_STATE =
        createField(DSL.name("USER_STATE"), SQLDataType.VARCHAR(1000000000).nullable(false), this, "");
